...
[[widget.selectable]]
==== selectable
* _selected_, _changed_ = *selectable*(_context_, [<<image, _image_>>], _text_, <<textalignflags, _textalignflags_>>, _selected_) +
...
[[widget.tree]]
==== tree
* _ok_ = *tree_push*(_context_, <<treetype, _treetype_>>, _title_, <<collapsestates, _collapsestates_>>, _hash_) +
*tree_pop*(_context_) +
